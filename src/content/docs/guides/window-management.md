...
Drag a tiled window over another to swap their positions. If swaps trigger too easily, increase `settings.window_snapping.drag_swap_fraction`; decrease it to require less overlap. The [general reference](/rift-docs/reference/configuration/general/) explains the threshold.
