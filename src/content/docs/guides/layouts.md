...
Choose a layout in the [comparison](/rift-docs/layouts/). Then add the relevant settings to your config. If a table already exists, edit it instead of repeating its header.
